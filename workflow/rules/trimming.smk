...
# generate a list of all files to be generated by the run_trimgalore rule (terminal files)
...
rule all:
    ...
    input:
        terminal_files,
    output:
        temp(touch(f"{work_dir}/progress/trimgalore.done")),


rule run_trimgalore:
    """
    Runs Trim Galore - Wrapper around cutadapt and FastQC to
