...
terminal_files: list = MetricsUtils.generate_terminal_files(
    in_dir=input_dir, out_dir=output_dir, flattened_sample_list=flattended_samples
)
...
rule run_picard_insertsizemetrics:
    """
...
rule run_picard_rnaseq_metrics:
    """
    Runs picard `CollectRnaSeqMetrics` and generates metrics
